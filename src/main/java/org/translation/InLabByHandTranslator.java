...
public class InLabByHandTranslator implements Translator {
    ...
    private static final String[] CANTRANSLATIONS = {"Kanada", "Canada", "加拿大"};
    ...
    public String translate(String country, String language) {
        ...
        if (country.equals(CANADA)) {
            int translationIndex = getCountryLanguages(CANADA).indexOf(language);
            if (translationIndex != -1) {
                return CANTRANSLATIONS[translationIndex];
            }
        }
        return null;
    }
